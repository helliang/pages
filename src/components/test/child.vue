        ...
        <div id="h-picker" v-if="show">
            <div class="area_ctrl">
                ...
                <div class="area_roll_mask">
                    <div class="area_roll">
                        <div>
                            <div top="0" ref="province"  class="gear area_province"
                                ...
                                <div class="tooth" v-for="(item,index) in pData1" :key="index"><span>{{item.name}}</span></div>
                            </div>
      ...
      //手指移动
        ...
        setGear(target, val) {
            ...
            if (!this.selectData.link) {
                if (type === 'provs') {
                    _self.selects.checkValue = _self.pData1[endVal]
                }
            }else{
                if(type === 'provs') {
                    _self.selects.checkValue = _self.pData1[endVal]
        ...
        setTop(defaultData) {
            this.$nextTick(()=> {
                ...
                if(defaultData[0] && defaultData[0].value) {
                    this.selects.checkValue = defaultData[0]
        ...
        init() {
            ...
            if(this.selectData.columns === 1) {
                this.selects.checkValue = this.pData1[0]
