    ...
    <div id="warningItem">
        <div class="panel" v-for="(item,index) in list" :key="index">
            ...
            <p class="total" v-if="item.isShowTotal">
                ...
                <span class="totalContent">{{item.total}}</span>
            </p>
            ...
            <ul class="panelData">
                <li v-for="(itemData,i) in item.data" :key="i">
                    ...
                    <div class="dataItem"  @click="listenToChildEvent(item.count[i])">
                    <!-- <div class="dataItem"  @click="listenToChildEvent(item.counts[i])"> -->
                        <!-- 男女名称 -->
                        <p class="dataTitle">{{itemData.dataTitle}}</p>
                        <!-- 数据 -->
                        <!-- <p class="dataContent">{{item.count[i]}}</p> -->
                        <!-- <p class="dataContent">{{item.count[i]["COUNT"]}}</p> -->
                        <p class="dataContent">{{counts[index][i]}}</p>
                    </div>
                </li>
            </ul>
        </div>
